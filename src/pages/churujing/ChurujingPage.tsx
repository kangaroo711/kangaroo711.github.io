...
function resolveRecordDraft(draft: RecordDraft): TravelRecord {
  return {
    ...
    documentType: (draft.documentTypeMode === customOptionValue ? draft.customDocumentType : draft.documentTypeMode).trim(),
        ...
        <div className="edit-mask" role="presentation" onClick={closeEditor}>
          ...
          >
            ...
            <input
              ...
              onChange={(event) => {
                setDraftValue(normalizeDraftValue(editingField, event.target.value));
                setDraftError('');
              }}
              onKeyDown={(event) => {
                if (event.key === 'Enter') {
            ...
            <div className="record-form">
              ...
              <label className="record-field">
                ...
                <select
                  ...
                  onChange={(event) => updateRecordDraft({ documentTypeMode: event.target.value })}
                >
